...
/* Verify the CRC32. */
bool Checksum::VerifyCRC32(u32 crc, u8 *buf, u32 startOffset, u32 size) {
	return CalculateCRC32Reflected(buf + startOffset + 4, size) == crc;
}

/* Update the CRC32. */
u32 Checksum::UpdateCRC32(u8 *rawData, u32 startOffset, u32 size) {
	u32 crc32 = CalculateCRC32Reflected(rawData + startOffset + 4, size);
